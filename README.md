...
> 중요: `/하네스 production-log-skill 생산일보 출력해줘` 같은 문장은 **터미널 명령어가 아니라 LLM/챗봇에서 사용할 예시 프롬프트**입니다.  
...
```text
/하네스 production-log-skill 생산일지 등록해줘. 날짜 2026-07-09, 품목 A-100, 수량 100, 양품 97, 불량 3
```
...
```text
/하네스 production-log-skill 전체 생산일지 조회해줘
```
...
```text
/하네스 production-log-skill 2026-07-09 생산일지 조회해줘
```
...
```text
/하네스 production-log-skill A-100 품목 생산일지 조회해줘
```
...
```text
/하네스 production-log-skill 품목별 집계해줘
```
...
```text
/하네스 production-log-skill 생산일보 출력해줘
```

```text
/하네스 production-log-skill 2026-07-09 생산일보 출력해줘
```
...
```text
/하네스 production-log-skill 불량률 계산해줘
```
...
```text
/하네스 production-log-skill data/my_production_log.csv 파일에 생산일지 저장해줘
```
...
3. **LLM 사이트에서 사용**  
   `/하네스 production-log-skill 생산일보 출력해줘` 같은 문장은 프롬프트입니다.  
